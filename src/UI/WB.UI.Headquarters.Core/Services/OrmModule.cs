...
namespace WB.UI.Headquarters.Services
{
    public class OrmModule : IModule, IInitModule
    {
        ...
        private void InitQuartz(ILoggerProvider loggerProvider)
        {
            DatabaseManagement.InitDatabase(this.connectionSettings.ConnectionString, "quartz");
            DbMigrationsRunner.MigrateToLatest(this.connectionSettings.ConnectionString, "quartz",
                this.connectionSettings.Quartz,
                loggerProvider);
        }
